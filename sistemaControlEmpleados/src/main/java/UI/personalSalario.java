...
public class personalSalario extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new personalSalario().setVisible(true);
            }
        });
    }
